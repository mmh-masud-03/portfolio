...
const ToolsAndTechnologies: React.FC = () => {
  return (
    <div className="flex flex-row flex-wrap justify-around w-full items-center bg-gradient-to-bl from-purple-50 to-purple-200 px-6 ">
      ...
      <ToolIcon name="Redux" src="/images/tools/redux.svg" />
      <ToolIcon name="MongoDB" src="/images/tools/mongodb.svg" />
      <ToolIcon name="Express" src="/images/tools/express.svg" />
    </div>
  );
};
